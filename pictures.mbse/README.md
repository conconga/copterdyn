...
![path\_trajectory.png](path_trajectory.png?raw=true "A possible path for the helicopter, and the respective trajectory for a safe landing.")
...
![Package\_02\_UseCases\_UseCases.JPG](Package_02_UseCases_UseCases.JPG?raw=true "Use-Case diagram, and details on stakeholders (I myself!) needs.")
...
![Package\_02\_SystemContext\_SoI\_Context.JPG](Package_02_SystemContext_SoI_Context.JPG?raw=true "Context Diagram.")
...
![Activity\_simulate\_hover\_simulate\_hover.JPG](Activity_simulate_hover_simulate_hover.JPG?raw=true "UseCase: simulate hover")
...
![Activity\_perform\_navigation\_perform\_navigation.JPG](Activity_perform_navigation_perform_navigation.JPG?raw=true "UseCase: perform navigation")
...
![Activity\_simulate\_sensors\_simulate\_sensors.JPG](Activity_simulate_sensors_simulate_sensors.JPG?raw=true "UseCase: simulate navigation")
...
![Functional
Allocation](Package_04_FunctionalAllocation_functional_allocation.JPG?raw=true "System of Interest: Functional Allocation")
...
![Package\_04\_FunctionalAllocation\_subsystems\_noname.JPG](Package_04_FunctionalAllocation_subsystems_noname.JPG?raw=true "Sub-activities allocated to sub-elements")
